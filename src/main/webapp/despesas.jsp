...
<div class="container py-5">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        ...
        <button class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#novaDespesaModal">Adicionar Despesa
        </button>
    </div>
            ...
            <div class="card shadow-sm">
                <div class="card-body d-flex justify-content-between align-items-center">
                    <div>
                        ...
                        <p class="mb-1">R$ <%= String.format("%.2f", d.getValor()) %>
                            - <%= new java.text.SimpleDateFormat("dd/MM/yyyy").format(d.getData()) %>
                        </p>
                        <p class="mb-0">Grupo: <%= d.getGrupo().getNome() %> | Pago por: <%= d.getPagador().getNome() %>
                        </p>
                    </div>
                    <div class="text-end">
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-select" name="grupo" required>
                            <%
                                for (Grupo g : grupos) {
                            %>
                            <option value="<%= g.getId() %>"><%= g.getNome() %>
                            </option>
                            <%
                                }
                            %>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-2">
                                <div class="input-group">
                                    ...
                                    <input type="number" step="0.01" class="form-control" name="valorPorParticipante"
                                           placeholder="Valor">
                                </div>
                            </div>
                            <%
