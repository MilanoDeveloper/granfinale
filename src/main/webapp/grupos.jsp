      ...
      <div class="card shadow-sm">
        <div class="card-body">
          ...
          <div class="mt-3 d-flex justify-content-end gap-3">
            <a href="#" class="text-primary" data-bs-toggle="modal" data-bs-target="#editarGrupoModal<%= grupo.getId() %>">&#9998;</a>
            <a href="#" class="text-danger" data-bs-toggle="modal" data-bs-target="#excluirGrupoModal<%= grupo.getId() %>">&#128465;</a>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="modal fade" id="excluirGrupoModal<%= grupo.getId() %>" tabindex="-1">
      <div class="modal-dialog">
        <form class="modal-content" action="excluir-grupo" method="post">
          ...
          <div class="modal-body">
            <p>Tem certeza que deseja excluir o grupo <strong><%= grupo.getNome() %></strong>?</p>
          </div>
          <div class="modal-footer">
