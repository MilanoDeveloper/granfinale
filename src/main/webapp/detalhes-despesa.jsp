...
<div class="container py-5">
  ...
  <div class="card shadow-sm">
    ...
    <div class="card-body">
      ...
      <p><strong>Valor:</strong> R$ <%= String.format("%.2f", d.getValor()) %></p>
      <p><strong>Data:</strong> <%= new java.text.SimpleDateFormat("dd/MM/yyyy").format(d.getData()) %></p>
      <p><strong>Grupo:</strong> <%= d.getGrupo().getNome() %></p>
      <p><strong>Pago por:</strong> <%= d.getPagador().getNome() %></p>
      <p><strong>Divisão:</strong></p>
      <ul>
        <%
          for (DespesaDivisao div : d.getDivisoes()) {
        %>
        <li><%= div.getParticipante().getNome() %> - R$ <%= String.format("%.2f", div.getValor()) %></li>
        <%
          }
        %>
      </ul>
