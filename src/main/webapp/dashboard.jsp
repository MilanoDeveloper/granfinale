        ...
        <div class="col-sm-6 col-md-4 col-lg-3 mb-4">
            <div class="card shadow-sm h-100">
                <div class="card-body">
                    ...
                    <p class="card-text">Gerencie os usuários do sistema, adicione novos membros e mantenha suas informações atualizadas.</p>
        ...
        <div class="col-sm-6 col-md-4 col-lg-3 mb-4">
            <div class="card shadow-sm h-100">
                <div class="card-body">
                    ...
                    <p class="card-text">Crie grupos para organizar suas despesas compartilhadas com amigos, família ou colegas.</p>
        ...
        <div class="col-sm-6 col-md-4 col-lg-3 mb-4">
            <div class="card shadow-sm h-100">
                <div class="card-body">
                    ...
                    <p class="card-text">Registre todas as suas despesas compartilhadas e mantenha um controle detalhado dos gastos.</p>
