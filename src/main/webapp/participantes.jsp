...
<div class="container py-5">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        ...
        <button class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#novoParticipanteModal">+ Novo
            Participante
        </button>
    </div>
        ...
        <div class="col-md-4 mb-4">
            <div class="card shadow-sm">
                <div class="card-body text-center">
                    ...
                    <p class="text-muted"><%= p.getEmail() %>
                    </p>
                    <div class="d-flex justify-content-center">
                        <a href="#" class="text-primary me-3" data-bs-toggle="modal"
                           data-bs-target="#editarModal<%= p.getId() %>">✏️</a>
                        <a href="#" class="text-danger" data-bs-toggle="modal"
                           data-bs-target="#excluirModal<%= p.getId() %>">🗑️</a>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="modal fade" id="excluirModal<%= p.getId() %>" tabindex="-1" aria-hidden="true">
            <div class="modal-dialog">
                <form class="modal-content" action="excluir-participante" method="post">
                    ...
                    <div class="modal-body">
                        <p>Tem certeza que deseja excluir <strong><%= p.getNome() %>
                        </strong>?</p>
                    </div>
                    <div class="modal-footer">
    ...
    <div class="modal fade" id="novoParticipanteModal" tabindex="-1" aria-labelledby="novoParticipanteModalLabel"
         aria-hidden="true">
        <div class="modal-dialog">
